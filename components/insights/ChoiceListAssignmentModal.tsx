...
export default function ChoiceListAssignmentModal({
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between border-b border-customGray-10 bg-white">
      ...
      <div className="min-h-0 flex-1 overflow-y-auto px-6 py-5">
        <div className="relative mb-5">
          ...
          <input
            ...
            className="h-11 w-full rounded-lg border border-customGray-10 bg-customGray-3 pl-11 pr-4 text-sm text-primary-dark outline-none focus:border-primary-blue/40"
          />
        </div>
          ...
          {filteredLists.map(list => (
            <button
              ...
              className={classNames(
                ...
                list.isSelected ? 'bg-secondary-lightRed/5 border border-secondary-lightRed/30' : 'hover:bg-customGray-5',
              )}
            >
