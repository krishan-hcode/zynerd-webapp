      ...
      {selectedCounselling ? (
        <div className=" min-h-[calc(100vh-77px)] pb-6">
          <InsightsPageLayout
            ...
            records={records}
            whatsThisTitle="What is Seat Matrix?"
            whatsThisBody="The Seat Matrix list contains all vacant seats available in each round of Counselling, categorised by quota and category. These represent actual seats within the Counselling process, not the institute's total seats. Seat availability may change yearly based on the methodology used and varies each round due to previous allotments and joinings."
          />
        </div>
      ) : null}
